...
const Hero = () => {
  return (
    <main className='flex flex-col sm:flex-row items-center px-[1rem] sm:px-[90px] 
     justify-center sm:space-x-8 '>
      <div className='flex flex-col sm:w-1/2 space-y-8 items-center sm:items-start w-full text-center sm:text-start'>
        ...
        <a href="" className='bg-[#458FF6] rounded-[55px] leading-[40px] text-white font-bold text-[18px] py-2 px-6 text-center
